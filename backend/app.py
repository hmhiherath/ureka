...
# Setting cors_allowed_origins="*" allows the frontend on port 3000 to connect
socketio = SocketIO(app, cors_allowed_origins="*", async_mode='threading')
triage_heap = TriageHeap()

# In-Memory Database (Replaces Postgres)
patients_db = {}
...
def handle_new_patient(raw_data):
    ...
    try:
        ...
        triage_heap.insert(patient_id_counter, score, arrival_time)
